    ...
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Tarefas != null ? 
                          ...
                          Problem("Entity set 'Contexto.Tarefas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("TarefaId,Nome,Data,Horario")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TarefaId,Nome,Data,Horario")] Tarefa tarefa)
        {
